        ...
        ; your function must mov the address of the sorted array to r0
          ...
          outer-loop:
                Inner-loop:
                        ...
                        swap value here
                        cmp r5, r6
                        strge r6, [r1, r3]  ;storing r6 to the address of array
                        strge r5, [r1, r4]  ;storing r5 to the address of array
                    
                        add r8, r8, #1
            cmp r8, r10
               
 blt Inner-loop                ;if r8 is LESS than r10, then continue loop
